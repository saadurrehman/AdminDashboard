...
// SVG plus icon
export const Plus = ({ color = "#300663", width = 12, height = 12 }) => {
  return (
    <span>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
// SVG minus icon
export const Minus = ({ color = "#300663", width = 12, height = 1.5 }) => {
  return (
    <span>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
// SVG Cart icon
export const CartIcon = ({ color = "#300663", width = 14, height = 12 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
// SVG Grocery icon
export const GroceryIcon = ({ color = "#300663", width = 14, height = 16 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const MakeupIcon = ({ color = "#300663", width = 12, height = 16 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const DressIcon = ({ color = "#300663", width = 8, height = 16 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const Handbag = ({ color = "#300663", width = 8 }) => {
  return (
    <svg
      version="1.1"
      id="Capa_1"
...
export const EllipsisIcon = ({ color = "#300663", width = 26, height = 6 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
// SVG ArrowNext icon
export const GiftBox = ({ color = "#300663", width = 15, height = 16 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
// SVG ArrowNext icon
export const ArrowNext = ({ color = "#300663", width = 20 }) => {
  return (
...
// SVG ArrowPrev icon
export const ArrowPrev = ({ color = "#300663", width = 20 }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={width}>
      <path
...
// SVG Lock icon
export const LockIcon = ({ color = "#300663", width = 15 }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={width}>
...
// SVG SearchIcon icon
export const SearchIcon = ({ color = "#300663", width = 17, height = 17 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
// SVG SmartPhone icon
export const SmartPhone = ({ color = "#300663", width = 16, height = 24 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
